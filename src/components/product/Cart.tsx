...
import { calculateShippingCost } from 'components/order/shippingCost';
...
export default function Cart() {
  ...
  const handleOrder = async () => {
    ...
    try {
      ...
      // 주문 데이터 생성
      const shippingCost = calculateShippingCost(items, shippingTerms);
      ...
      navigate(`/order-detail/${orderRef.id}`, { state: { orderId } });
                ...
                <td className="px-6 py-2 whitespace-nowrap">
                  <div className="flex items-center">
                    <input
                      ...
                      className="w-16 px-2 py-1 border rounded focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                    />
                  </div>
                </td>
